package com.example.check17_pontosveiculo.ui.login.registro;
...
import com.example.check17_pontosveiculo.ui.login.LoginActivity;
...
public class Registro_User extends AppCompatActivity {
    ...
    String url_Register = "http://transcr10.com/chek17pontos/registro_user.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new RegistrarUsuario().execute(Name, Email, Password);
            }
        });
    }
                ...
                try {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        if (result.equalsIgnoreCase("User registered successfully")) {
                            showToast("Usuário Cadastro");
                            Intent i = new Intent(Registro_User.this,
                                    LoginActivity.class);
                            startActivity(i);
                            finish();
    ...
    public void showToast(final String Text){
        this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(Registro_User.this,
